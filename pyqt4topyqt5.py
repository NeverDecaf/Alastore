            ...
            if function[i] == '(':
                ...
                while inside != 0:
                    ...
                    if function[i] == '"' or function[i] == "'":
                        ...
                        if function[i+1]==function[i] and function[i+2]==function[i]:
                            str_delimiter = function[i:i+3]
                        while True:
                            slices[current] += function[i]
                            i += 1
                            if function[i:i+len(str_delimiter)] == str_delimiter:
                                i+=len(str_delimiter)-1
                                break
                    if function[i] == '(':
                        inside += 1
                    elif function[i] == ')':
